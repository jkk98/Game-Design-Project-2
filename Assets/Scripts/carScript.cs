...
public class carScript : MonoBehaviour {
	...
	void FixedUpdate () {
		...
		if (ticks % 200 == 0)
		{
			GameObject testdinosaur = Instantiate(dinosaur2, transform.position + (transform.right * 1.0f * 1.0f) + (transform.up * 1.0f), Quaternion.Euler(0, 0, 0)) as GameObject;
		}
